...
from models.statutory_document import StatutoryDocument, DOC_STATUS_EXPIRING_SOON, DOC_STATUS_EXPIRED
...
def index():
    ...
    all_statutory_docs = StatutoryDocument.query.all()
    docs_expiring_soon = sum(1 for d in all_statutory_docs if d.computed_status() == DOC_STATUS_EXPIRING_SOON)
    docs_expired = sum(1 for d in all_statutory_docs if d.computed_status() == DOC_STATUS_EXPIRED)
